...
namespace PropertyGridShowRoom
{
    public class MyPropertyGrid : PropertyGrid
    {
        ...
        public class Planet
        {
            ...
            {
                if (obj is not Planet planet)
                    return false;

                return name.Equals(planet.name) && (position == planet.position);
            }
        ...
        private readonly TargetClass _targetInstance = new();
        ...
        public class MyBoolConverter : TypeConverter
        {
            ...
            public override object? ConvertTo(ITypeDescriptorContext? context, CultureInfo? culture, object? value, Type destinationType)
            {
                if (destinationType == typeof(String))
                {
                    if (MyBoolClass.True.Equals(value))
                        return "Value defined";
                    else if (MyBoolClass.False.Equals(value))
                        return "No value";
                }
        ...
        {
            public static readonly MyBoolClass True = new(true);

            public static readonly MyBoolClass False = new(false);
            ...
            public override bool Equals(object? obj)
            {
                ...
                if (obj is MyBoolClass)
                    return value == (obj as MyBoolClass)?.value;
        ...
        public void Populate()
        {
            ...
            ((RootCategory)rootEnum.Property).ValueText = "(14 properties)";
...
/*
        ...
        */
        ...
        void MyPropertyGrid_InPlaceCtrlVisible(object sender, InPlaceCtrlVisibleEventArgs e)
        {
            ...
            else if (e.InPlaceCtrl is PropInPlaceTrackbar tb)
            {
                tb.RealtimeChange = false;
            }
            else if (e.InPlaceCtrl is PropInPlaceButton btn)
            {
 ...
 */
        ...
        void TextBox_TextChanged(object sender, EventArgs e)
        {
            ...
            if (tb != null)
            {
                var propValue = SelectedPropertyEnumerator.Property.Value;
                object? value = null;
                ...
                if (!propValue.ValidateValue(value, out PropertyEnumerator invalidPropEnum))
                {
        ...
        void MyPropertyGrid_PropertyCreated(object sender, PropertyCreatedEventArgs e)
        {
            ...
            {
                var childEnum = e.PropertyEnum.Children;
                if (childEnum.Count > 0)
                {
                    ...
                    var propEnum = InsertProperty(childEnum, 150, "Color", _targetInstance, "FontColor", "");
                    propEnum.Property.Feel = GetRegisteredFeel(FeelList);
                    propEnum.Property.Look = new PropertyAlphaColorLook();
        ...
        public MyPropertyGrid()
        {
            ...
            resourceManager = new ResourceManager("PropertyGridShowRoom.MainResources", Assembly.GetExecutingAssembly());
...
//                    DeleteProperty(SelectedPropertyEnumerator);
  //                  return true;
        ...
        {
            var manager = DrawManager as LightColorDrawManager;
            if (manager != null)
            {
        ...
        protected override void OnMouseDown(MouseEventArgs e)
        {
            ...
            {
                if (e is SPGMouseEventArgs args)
                {
