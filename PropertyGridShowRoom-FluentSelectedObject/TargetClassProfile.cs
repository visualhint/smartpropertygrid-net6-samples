    ...
    public class TargetClassProfile : SelectedObjectProfile
    {
        ...
        public TargetClassProfile()
        {
            ...
            AddTargetConfiguration<TargetClass>()
                ...
                // Define the Textboxes category and properties inside
                .ForCategory(TextboxesCategory, config => config
                    .Sorted(1)
                    .ImageIndex(5)
                ...
                .ForCategory(ButtonsCategory, config => config
                    .Sorted(2)
                    .Comment("This category has a non editable value. This is useful for example to show a key child property value when the category is collapsed.")
                    .ValueText("(11 properties)")
                ...
                .ForCategory(ListsCategory, config => config
                    .Sorted(3)
                ...
                .ForCategory(EditorsCategory, config => config
                    .Comment("SPG.Net is now compatible with all Microsoft and custom UITypeEditors.")
                    .Sorted(4)
                ...
                .ForCategory(MiscellaneousCategory, config => config
                    .Sorted(5)
                ...
                .ForCategory(ReflectionCategory, config => config
                    .Sorted(6)
