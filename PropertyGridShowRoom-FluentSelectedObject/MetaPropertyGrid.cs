...
//            resourceManager = new ResourceManager("WindowsApplication.MainResources", Assembly.GetExecutingAssembly());
            ...
            ColorUtils.RGBtoHSL(GridColor, out double H, out double S, out double L);
        ...
        private readonly Color _hoveredPropertyBackColor;
        ...
        public void Populate(PropertyGrid targetPropertyGrid)
        {
            ...
            _targetPropertyGrid.RightToLeftChanged += new EventHandler(TargetPropertyGrid_RightToLeftChanged);
            _targetPropertyGrid.DrawingManagerChanged += new DrawingManagerChangedEventHandler(TargetPropertyGrid_DrawingManagerChanged);
        ...
        void TargetPropertyGrid_DrawingManagerChanged(object sender, EventArgs e)
        {
        ...
        void TargetPropertyGrid_RightToLeftChanged(object? sender, EventArgs e)
        {
        ...
        void OnTargetGridSizeChanged(object? sender, EventArgs e)
        {
            ...
            {
                if (_commentsHeightPropEnum.Property.Value.Validator is PropertyValidatorMinMax validator)
                    validator.Max = _targetPropertyGrid.Height - 2 * _targetPropertyGrid.BasicPropertyHeight - (_targetPropertyGrid.Toolbar != null ? _targetPropertyGrid.Toolbar.Height : 0);

                if ((SelectedPropertyEnumerator == _commentsHeightPropEnum) && (InPlaceControl != null))
                {
                    // It will reinitialize the trackbar
                    if (InPlaceControl is PropInPlaceTrackbar ctrl)
                        ctrl.OwnerPropertyEnumerator = _commentsHeightPropEnum;
                }
            }
        }
        ...
        protected override void OnPropertyChanged(VisualHint.SmartPropertyGrid.PropertyChangedEventArgs e)
        {
            ...
            else if (e.PropertyEnum == _commentsHeightPropEnum)
            {
                ...
                _ = Win32Calls.RedrawWindow(_targetPropertyGrid.Handle, IntPtr.Zero, IntPtr.Zero,
...
//            BeginVerticalFreeze();    // Would keep the first visible property in place
            ...
            AppendProperty(rootEnum, _id++, "DisplayName", property, "DisplayName", "");

            PropertyEnumerator propEnum = AppendProperty(rootEnum, _id++, "Comment", property, "Comment", "");
 ...
 //           propEnum.Property.HeightMultiplier = 3;
            ...
            AppendProperty(rootEnum, _id++, "Font", property, "Font", "",
                new PropertyHideAttribute("GdiCharSet"),
                new PropertyHideAttribute("GdiVerticalFont"),
                new PropertyHideAttribute("Unit"),
                new PropertyFeelAttribute("Size", PropertyGrid.FeelEditUpDown));
            ...
            if (propertyValue != null)
            {
                ...
                AppendProperty(subcatEnum, _id++, "Font", propertyValue, "Font", "",
                    new PropertyHideAttribute("GdiCharSet"),
                    new PropertyHideAttribute("GdiVerticalFont"),
                    new PropertyHideAttribute("Unit"),
                    new PropertyFeelAttribute("Size", PropertyGrid.FeelEditUpDown));
                ...
                AppendProperty(subcatEnum, _id++, "Show icon from", propertyValue, "ImageSource", "");
