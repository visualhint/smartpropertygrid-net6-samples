...
namespace PropertyGridShowRoom
{
    ...
    {
        private readonly float _min1;

        private readonly float _max1;

        private readonly float _min2;

        private readonly float _max2;
        ...
        {
            if (obj is not PropertyValidatorPointFMinMax validator)
                return false;
